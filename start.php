...
<div class="section no-pad-bot enter_text" id="index-banner">
	<div class="container">
		<br><br>
		<h1 class="header center orange-text">Article For You</h1>
		<div class="row center">
			<h5 class="header col s12 light">The greatest article collection </h5>
		</div>
		<div class="row center">
			<a href="registry.php" id="download-button" class="btn-large waves-effect waves-light orange">Get Started</a>
		</div>
		<br><br>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col l3 s12">
				...
				<ul>
					<li><a class="white-text" href="index.php/articles">Aeticle 1</a></li>
